...
$db       = 'bfakoluj_aurum';     // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'bfakoluj_gold';     // Enter YOUR cPanel username and user here
$password = '?CGwm(pbV)LL!';           // Enter YOUR user password here
